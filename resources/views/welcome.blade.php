                                ...
                                <div class="menu-fullwidth">
                                    <div class="logo-wrapper order-lg-0 order-sm-1">
                                        <div class="logo logo-top">
                                            <a href="index.html"><img src="img/logo-white.png" alt="logo image"
                                                    class="img-fluid"></a>
                                        </div>
                                                    ...
                                                    <ul class="navbar-nav">
                                                        ...
                                                        <li class="dropdown has_dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="drop3">
                                                                <li><a href="all-listings-grid.html">Listing Grid</a>
                                                                </li>
                                                                <li><a href="all-listings-list.html">Listing List</a>
                                                                </li>
                                                        ...
                                                        <li class="dropdown has_dropdown">
                                                            <a href="#" class="dropdown-toggle" id="drop4" role="button"
                                                                data-toggle="dropdown" aria-haspopup="true"
                                                                aria-expanded="false">Categories</a>
                                                            <ul class="dropdown-menu" aria-labelledby="drop4">
                                                                <li><a href="all-categories.html">All Categories</a>
                                                                </li>
                                                        ...
                                                        <li class="dropdown has_dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="drop2">
                                                                <li><a href="author-profile.html">Author Profile</a>
                                                                </li>
                                                                <li><a href="dashboard-listings.html">Author
                                                                        Dashboard</a></li>
                                                        ...
                                                        <li class="dropdown has_dropdown">
                                                            <a class="dropdown-toggle" href="#" id="drop1" role="button"
                                                                data-toggle="dropdown" aria-haspopup="true"
                                                                aria-expanded="false">
                                                                Blog
                                                            </a>
                                                            <ul class="dropdown-menu" aria-labelledby="drop1">
                                                                ...
                                                                <li><a href="blog-details-standard.html">Blog
                                                                        Details</a></li>
                                                                <!-- dropdowns example -->
                                    ...
                                    <div class="menu-right order-lg-2 order-sm-2">
                                        <div class="search-wrapper">
                                            ...
                                            <div class="search-categories">
                                                <ul class="list-unstyled">
                                                    <li><a href=""><span class="la la-glass bg-danger"></span> Food &
                                                            Drinks</a></li>
                                                    <li><a href=""><span class="la la-cutlery bg-primary"></span>
                                                            Restaurants</a></li>
                                                    <li><a href=""><span class="la la-map-marker bg-success"></span>
                                                            Places</a></li>
                                                    <li><a href=""><span
                                                                class="la la-shopping-cart bg-secondary"></span>
                                                            Shopping & Store</a></li>
                                                    <li><a href=""><span class="la la-bed bg-info"></span> Hotels</a>
                                                    </li>
                                                    <li><a href=""><span class="la la-bank bg-warning"></span> Art &
                                                            History</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="offcanvas-menu__contents">
                                                ...
                                                <div class="search_area">
                                                    <form action="/">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-sm btn-secondary">Search</button>
                                                    </form>
                ...
                <div class="col-lg-12">
                    <div class="atbd_generic_header">
                        ...
                        <div class="atbd_listing_action_btn btn-toolbar align-items-center" role="toolbar">
                            <!-- Views dropdown -->
                            <div class="view-mode">
                                <a class="action-btn" href="all-listings-grid.html"><span
                                        class="la la-th-large"></span></a><a class="action-btn active"
                                    href="all-listings-list.html"><span class="la la-list"></span></a>
                            </div>
                            <!-- Orderby dropdown -->
                            <div class="dropdown">
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="form-group">
                                            <div class="position-relative">
                                                ...
                                                <button type="submit" class="locator"><span
                                                        class="la la-crosshairs"></span></button>
                                            </div>
                                        </div><!-- ends: .form-group -->
                                        ...
                                        <div class="check-btn">
                                            <div class="btn-checkbox active-color-secondary">
                                                <label>
                                                    <input type="checkbox" value="1"><span class="color-success"><i
                                                            class="la la-clock-o"></i> Open Now</span>
                                                </label>
                                            </div>
                                            <div class="btn-checkbox active-color-secondary">
                                                <label>
                                                    <input type="checkbox" value="1"><span class="color-primary"><i
                                                            class="la la-tags"></i> Offering Deal</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="filter-checklist">
                                            ...
                                            <div class="checklist-items feature-checklist hideContent">
                                                <div
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="tag9"
                                                        checked>
                                                    <label class="custom-control-label" for="tag9">Accepts
                                                        Cards</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                                                ...
                                                <div
                                                    ...
                                                    <label class="custom-control-label" for="tag11">Bike
                                                        Parking</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                                                ...
                                                <div
                                                    ...
                                                    <label class="custom-control-label" for="tag14">WiFi
                                                        Internet</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                                                    <input type="checkbox" class="custom-control-input" id="tag15">
                                                    <label class="custom-control-label" for="tag15">Parking
                                                        Street</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                                                ...
                                                <div
                                                    ...
                                                    <label class="custom-control-label" for="tag17">Travel
                                                        Booking</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                                                    <input type="checkbox" class="custom-control-input" id="tag18">
                                                    <label class="custom-control-label" for="tag18">Fast
                                                        Support</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                                                    <input type="checkbox" class="custom-control-input" id="tag19">
                                                    <label class="custom-control-label" for="tag19">Parking
                                                        Street</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                                        ...
                                        <a href=""
                                            ...
                                            Filter <span class="la la-long-arrow-right"></span></a>
                                    </form><!-- ends: form -->
                                </div><!-- ends: .default-ad-search -->
                            </div>
                        </div><!-- ends: .col-lg-4 -->
                        <div class="col-lg-8 order-0 order-lg-1">
                            <div class="row listOurData">



                                @foreach ($listings as $vaue)
                                    <div class="col-lg-12">
                                            ...
                                            <article class="atbd_single_listing_wrapper">
                                                <figure class="atbd_listing_thumbnail_area">
                                                    <div class="atbd_listing_image">
                                                        <a href="">
                                                            <img src="{{ $vaue->photo }}" alt="listing image">
                                                        </a>
                                                    ...
                                                    <div class="atbd_thumbnail_overlay_content">
                                                        <ul class="atbd_upper_badge">
                                                            @if ($vaue->tag == 1)
                                                                <li><span
                                                                        class="atbd_badge atbd_badge_featured">Featured</span>
                                                                </li>
                                                            @elseif ($vaue->tag == 2)
                                                                <li><span
                                                                        class="atbd_badge atbd_badge_popular">Popular</span>
                                                                </li>
                                                            @else
                                                                <li><span class="atbd_badge atbd_badge_new">New</span>
                                                                </li>
                                                            @endif
                                                ...
                                                <div class="atbd_listing_info">
                                                    <div class="atbd_content_upper">
                                                        ...
                                                        <div class="atbd_listing_meta">
                                                            <span
                                                                class="atbd_meta atbd_listing_rating">{{ $vaue->rating }}.0<i
                                                                    class="la la-star"></i></span>
                                                            <span
                                                                class="atbd_meta atbd_listing_price">${{ $vaue->price }}</span>
                                                        ...
                                                        <div class="atbd_listing_data_list">
                                                            <ul>
                                                                <li>
                                                                    <p><span
                                                                            class="la la-map-marker"></span>{{ $vaue->location }}
                                                                    </p>
                                                                </li>
                                                                <li>
                                                                    <p><span class="la la-phone"></span>(415)
                                                                        {{ $vaue->phone }}
                                                                    </p>
                                                                </li>
                                                                <li>
                                                                    <p><span
                                                                            class="la la-calendar-check-o"></span>Posted
                                                                        2
                                                                        months ago</p>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <div class="atbd_listing_bottom_content">
                                                        ...
                                                        <ul class="atbd_content_right">
                                                            <li class="atbd_count"><span
                                                                    class="la la-eye"></span>{{ $vaue->seen }}+
                                                            </li>
                                                            <li class="atbd_save">
                                                            ...
                                                            <li>
                                                                <div class="atbd_author atbd_author--thumb">
                                                                    <a href="">
                                                                        <img src="img/author-thumb2.jpg"
                                                                            alt="Author Image">
                                                                        <span class="custom-tooltip">Jeffery A,
                                                                            Owner</span>
                                                                    </a>
                                                                </div>
                                                            </li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <nav class="navigation pagination d-flex justify-content-end" role="navigation">
                                        <div class="nav-links">
                                            <a class="prev page-numbers" href=""><span
                                                    class="la la-long-arrow-left"></span></a>
                                            <a class="page-numbers" href="">1</a>
                                            <span aria-current="page" class="page-numbers current">2</span>
                                            <a class="page-numbers" href="">3</a>
                                            <a class="next page-numbers" href=""><span
                                                    class="la la-long-arrow-right"></span></a>
                                        </div>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="widget widget_social">
                            ...
                            <ul class="list-unstyled social-list">
                                <li><a href=""><span class="mail"><i class="la la-envelope"></i></span>
                                        Contact Support</a></li>
                                <li><a href=""><span class="twitter"><i class="fab fa-twitter"></i></span>
                                        Twitter</a></li>
                                <li><a href=""><span class="facebook"><i class="fab fa-facebook-f"></i></span>
                                        Facebook</a></li>
                                <li><a href=""><span class="instagram"><i class="fab fa-instagram"></i></span>
                                        Instagram</a></li>
                                <li><a href=""><span class="gplus"><i
                                                class="fab fa-google-plus-g"></i></span> Google+</a></li>
                            </ul>
                        </div><!-- ends: .widget -->
                    </div><!-- ends: .col-lg-3 -->
                            ...
                            <div class="textwidget">
                                ...
                                <ul class="list-unstyled store-btns">
                                    ...
                                    <li><a href="" class="btn btn-dark btn-md btn-icon btn-icon"><span
                                                class="fab fa-android"></span> Google Play</a></li>
                                </ul>
                            </div>
                        </div><!-- ends: .widget -->
                    </div><!-- ends: .col-lg-3 -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-bottom--content">
                            ...
                            <p class="m-0 copy-text">©2019 Direo. Made with <span class="la la-heart-o"></span> by
                                <a href="">Aazztech</a>
                            </p>
                ...
                <div class="modal-body">
                    <form action="/" id="login-form">
                        ...
                        <div
                            ...
                            <input type="checkbox" class="custom-control-input" name="keep_signed_in" value="1"
                                id="keep_signed_in">
                            <label for="keep_signed_in" class="not_empty custom-control-label">Keep me signed
                                in</label>
                        </div>
                        <button type="submit" class="btn btn-block btn-lg btn-gradient btn-gradient-two">Sign
                            In</button>
                    </form>
                    <div class="form-excerpts">
                        ...
                        <div class="social-login">
                            ...
                            <p><a href="" class="btn btn-outline-secondary"><i class="fab fa-facebook-f"></i>
                                    Facebook</a><a href="" class="btn btn-outline-danger"><i
                                        class="fab fa-google-plus-g"></i> Google</a></p>
                        </div>
                    </div>
                </div>
            </div>
